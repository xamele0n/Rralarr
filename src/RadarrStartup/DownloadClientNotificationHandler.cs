...
namespace RadarrStartup.Common;

public abstract class ProviderSyncNotificationHandler<T, TDef> where TDef : ProviderDefinition, new()
    where T : IProvider
{
    protected readonly IProviderFactory<T, TDef> _providerFactory;
